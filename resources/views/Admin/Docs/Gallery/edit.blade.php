...
@section('content')
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('puteditdatagallery', $detail->id) }}"
        ...
        <div class="mx-10 mt-10">
            <div class="relative w-full">
                ...
                <input name="judul_gallery" value="{{ $detail->judul_gallery }}"
            ...
            <div class="relative w-full">
                ...
                <input name="tanggal_publish" value="{{ $detail->tanggal_publish }}" disabled id="Test_DatetimeLocal"
            ...
            <div class="relative w-full">
                ...
                <img src="{{ asset('img/gallery/' . $detail->gambar) }}" alt="berita" width="300" />
            </div>
