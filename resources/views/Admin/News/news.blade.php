        ...
        <div class="grid grid-cols-3 gap-4">
            @foreach ($news as $item)
                <div class="p-4 bg-white rounded-lg shadow-xl flex">
                    <img class="mr-2 fa-solid fa-comment text-gray-500 dark:text-gray-400 text-4xl my-4 rounded-md" src="{{ asset('img/news/' . $item->gambar) }}" alt="berita"></img>
                    <div class="flex flex-col">
                        <h2 class="text-xl font-bold mt-4">{{ $item->judul_gallery }}</h2>
...
{{-- <div class="overflow-x-hidden md:w-[calc(100%-256px)] md:ml-64 mt-16 w-full">
    ...
    <div class="ml-4 mr-4">
        <div class="grid grid-cols-3 gap-4">
            <div class="p-4 bg-white rounded-lg shadow-xl flex">
                <img class="mr-2 fa-solid fa-comment text-gray-500 dark:text-gray-400 text-4xl my-4 rounded-md" src="https://source.unsplash.com/random/120x120?" alt="berita"></img>
                <div class="flex flex-col">
                    <h2 class="text-xl font-bold mt-4">Berita Acara Title</h2>
                    <p>Tanggal</p>
                    <p>Deskripsi</p>
                    <div class="mt-2 flex justify-evenly gap-4">
                        <a href="{{ route('detaildatanews') }}" class="bg-blue-500 text-white font-semibold py-1 px-3 border border-blue-500 rounded-lg shadow">Detail</a>
                        <a href="{{ route('editdatanews') }}" class="bg-yellow-500 text-white font-semibold py-1 px-3 border border-yellow-500 rounded-lg shadow">Edit</a>
