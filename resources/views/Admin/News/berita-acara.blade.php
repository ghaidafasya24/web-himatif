    ...
    <div class="overflow-x-hidden md:w-[calc(100%-256px)] md:ml-64 mt-16 w-full">
        ...
        <table class="table-auto min-w-full divide-y divide-gray-200 overflow-x-hidden">
            <thead class="bg-gray-50">
                <tr>
                    <th scope="col"
                        class="px-10 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Judul Berita
                        Acara</th>
                    <th scope="col"
                        class="px-10 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tanggal
                        Terbit</th>
                    <th scope="col"
                        class="px-10 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Kategori
                    </th>
                    <th scope="col"
                        class="px-10 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Penulis</th>
                    <th scope="col"
