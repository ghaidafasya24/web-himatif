...
<main class="bg-slate-100">
    <div class="py-52 grid grid-cols-2 gap-4">
        <div class="flex items-center">
            <div class="ml-20">
                <h1 class="text-red-500 font-bold text-7xl" style="font-family: 'Outfit', sans-serif;">Himpunan<br>Mahasiswa<br>Teknik Informatika</h1>
                <p class="text-red-500 mb-4">Universitas Logistik & Bisnis Internasional</p>
                <a href='{{ route('oprac') }}' class="transition mt-10 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-6 rounded-full transition duration-300 ease-in-out">Join</a>
            </div>
        </div>
