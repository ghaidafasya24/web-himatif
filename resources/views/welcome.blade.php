            ...
            <div class="py-40 grid grid-cols-2 gap-4 bg-white">
                ...
                <div class="flex items-center">
                    <div class="mr-20">
                        ...
                        <p class="mt-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident hic sunt labore nostrum dicta, quibusdam itaque ipsam. Ad itaque aliquid aperiam iure similique, vitae architecto placeat, hic cumque earum asperiores perspiciatis labore, dolore odit quam a dolores expedita eius? Delectus eos autem vero aperiam, nostrum placeat quaerat dignissimos deleniti molestiae! Eaque quas quos quam, quis magnam qui adipisci recusandae delectus, fugiat iure, optio fugit maiores ut quae amet aspernatur. Ipsum nesciunt, similique eaque voluptates numquam, quo minima obcaecati laboriosam soluta temporibus, aliquid possimus quidem odit totam! Est deleniti facere, tempore aspernatur doloribus beatae quas, harum sit fugiat, tempora sed odit.</p>
                    </div>
                </div>
            </div>
            <div class="py-32">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="text-center px-20 mt-16">
                        ...
                        <p>Menjadi program studi yang unggul secara nasional di bidang teknologi informasi yang mendukung bidang logistik dan manajemen rantai pasok pada tahun 2020</p>
                    </div>
                    <div class="px-20 mt-16">
                        ...
                        <ol>
                            ...
                            <li>Menerapkan ilmu pengetahuan dan TIK yang relevan dengan peningkatan layanan TIK di industri logistik</li>
                            <li>Melakukan pengabdian kepada masyarakat untuk memenuhi kebutuhan industrialisasi dan meningkatkan kesejahteraan masyarakat dengan pembekalan ilmu pengetahuan dan teknologi</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <footer>
            <section class="bg-white">
                <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                    ...
                    <p class="mt-8 text-base leading-6 text-center text-gray-400">© 2023 DevTeam. Himpunan Mahasiswa Teknik Informatika</p>
                </div>
            </section>
        </footer>
    </body>
