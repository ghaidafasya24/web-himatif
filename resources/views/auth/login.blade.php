    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 pb-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div>
                    {{-- <label class="block font-medium text-sm text-gray-700" for=" " value="Email" /> --}}
                    <input type="text" name="npm" placeholder="NPM" class="w-full rounded-md py-2.5 px-4 border text-sm outline-[#f84525]" />
                </div>
                ...
                <div class="flex items-center justify-end mt-4">
                    <button class="ms-4 inline-flex items-center px-4 py-2 bg-[#f84525] border border-transparent rounded-md font-semibold text-xs text-white uppercase hover:bg-red-800 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition ease-in-out duration-150">
                        Sign In</button>
                </div>
            </form>
        </div>
