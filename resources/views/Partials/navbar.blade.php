        ...
        <div class="flex items-center justify-between">
            ...
            <div class="space-x-5 pr-20 flex">
                ...
                <div class="relative inline-block text-left">
                    ...
                    <div id="gambar" class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                        <div class="py-1" role="none">
                            <a href="{{ route('bebas') }}" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Foto-Foto</a>
                            <a href="{{ route('proker') }}" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-2">Dokumentasi Materi</a>
                        </div>
                    </div>
                </div>

                <a href="{{ route('oprac') }}" class="text-red-500 font-semibold hover:opacity-80 transition duration-300">Oprec</a>
