        ...
        <div class="flex items-center justify-between">
            ...
            <div class="space-x-5 pr-20 flex">
                ...
                <button
                    ...
                    <div
                        class="group-focus:block hidden absolute top-full min-w-full w-max bg-white shadow-mb mt-1 rounded">
                        <ul class="border-2 bg-white text-left rounded gap-2">
                            <li><a href="{{ route('angkatan') }}"
                                    class="pr-6 pl-2 py-1 text-red-500 font-semibold hover-bg-slate-200 hover:opacity-80 transition duration-300">Angkatan</a>
                            </li>
                            <li><a href="{{ route('bebas') }}"
                                    class="pt-2 pr-6 pl-2 py-1 text-red-500 font-semibold hover-bg-slate-200 hover:opacity-80 transition duration-300">Bebas</a>
                            </li>
                            <li><a href="{{ route('proker') }}"
                                    class="pt-2 pr-6 pl-2 py-1 text-red-500 font-semibold hover-bg-slate-200 hover:opacity-80 transition duration-300">Proker</a>
                            </li>
                        </ul>
                    </div>
