...
<form class="pt-28 mx-auto max-w-lg" method="post" action="/DataAnggotaHimpunan">
    @csrf
    <div class="flex flex-col text-center w-full">
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Open donasi</h1>
    </div>
